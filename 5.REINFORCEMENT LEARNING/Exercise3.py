...
#------------------------------------------------------------------------------
# MODIFIED LINES FOR SOLUTION: 11, 22, 25, 61, 86
import numpy as np
...
def update(current_state, action, g):
    ...
    # Q learning formula
    Q[current_state, action] = Q[current_state, action] +alpha * (R[current_state, action] + g * max_value - Q[current_state, action])
